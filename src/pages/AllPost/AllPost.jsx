...
// import { FaThumbsUp, FaThumbsDown, FaCommentDots, FaShareAlt, FaSearch } from "react-icons/fa";
...
//   if (loading) {
//     return <div className="text-center mt-24 text-xl"><Loader></Loader></div>;
//   }

//   return (
//     <div className="min-h-screen w-full mt-12 flex flex-col justify-between px-2 md:px-0">
//       {/* Sort/Search/Tag Filter Section */}
//       <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 px-2">
//         <div className="flex flex-wrap gap-3 w-full md:w-auto">
//           <input
//             type="text"
//             placeholder="Search post title..."
//             className="border rounded-full px-4 py-2 text-sm bg-base-200 w-full md:w-64"
//             value={searchText}
//             onChange={(e) => setSearchText(e.target.value)}
//           />
//           <select
//             className="border rounded-full px-4 py-2 text-sm bg-base-200"
//             value={selectedTag}
...
//             className="px-4 py-2 border rounded-full bg-base-200 hover:bg-green-600 hover:text-white text-sm"
//           >
...
//       {/* Post Grid */}
//       <div className={`grid ${homeView ? "grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" : "grid-cols-1 gap-6 max-w-4xl mx-auto"}`}>
...
//               <div className="w-full h-auto overflow-hidden bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow p-4 space-y-4 border border-gray-200">
//                 <div className="flex items-start gap-4">
//                   <img
//                     className="h-12 w-12 rounded-full object-cover ring-2 ring-blue-500 flex-shrink-0"
...
//                     <p className="text-sm break-words line-clamp-2 text-gray-700">{post.description}</p>
//                   </div>
//                 </div>
//                 <div className="flex justify-between items-center text-xs flex-wrap gap-2 text-gray-600">
//                   <span className="whitespace-nowrap">
//                     🕒 {new Date(post.postTime).toLocaleDateString()} by <span className="font-medium">{post.authorName}</span>
//                   </span>
...
//               className={`px-3 py-1.5 rounded border text-sm transition-all duration-200 ${currentPage === num + 1 ? "bg-blue-500 text-white" : "bg-white text-gray-700 hover:bg-gray-100"}`}
//             >
//               {num + 1}
//             </button>
//           ))}
