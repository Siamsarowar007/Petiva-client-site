...
const PostDetails = () => {
  ...
  useEffect(() => {
    const fetchPostAndComments = async () => {
      ...
      try {
        ...
        const commentRes = await axiosInstance.get(`/comments/${id}`);
  ...
  const handleVote = async (voteType) => {
    ...
    try {
      const res = await axiosInstance.patch(`/posts/vote/${id}`, {
        userId: user.email,
        voteType,
      });
  ...
  const shareUrl =
    typeof window !== "undefined"
      ...
      : `${import.meta.env.VITE_SITE_URL || ""}/post-details/${id}`;
    ...
    <div className="mt-20 px-4 py-6">
      ...
      <article className="relative bg-white max-w-4xl mx-auto rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 sm:p-8">
          ...
          {/* Reaction Bar */}
          <div
            className="relative flex flex-wrap items-center gap-8 sm:gap-10 py-4 px-5 rounded-lg border mb-10"
          ...
          >
            ...
            <div className="relative" ref={shareRef}>
              ...
              {showShare && (
                <div
                  className="absolute right-0 mt-2 z-10 flex items-center gap-3 bg-white border rounded-lg shadow-md px-3 py-2"
                  style={{ borderColor: PRIMARY }}
                >
                  <FacebookShareButton
                    url={shareUrl}
