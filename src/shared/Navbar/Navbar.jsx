...
const Navbar = () => {
  ...
  return (
    <div className="bg-base-100 shadow-sm sticky top-0 z-50">
      <div className="navbar px-4 lg:px-1 flex justify-between items-center max-w-7xl mx-auto"> 
        {/* Logo & Name */}
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  <Link to="/dashboard/profile">
                    <li className="font-semibold flex ml-4 text-sm md:text-base lg:text-lg gap-2"> 
                      <FaUserCircle /> {user.displayName || "User"}
                    </li>
                  </Link>
                  <li>
                    <NavLink to="/dashboard" className="flex items-center gap-2 text-sm md:text-base lg:text-lg hover:text-[#4CA3B8]"> 
                  ...
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-red-500 hover:text-red-600 text-sm md:text-base lg:text-lg" 
                    >
