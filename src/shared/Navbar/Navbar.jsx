...
//         const all = res.data;
//         const readIds =
//           JSON.parse(localStorage.getItem("read_announcements")) || [];
...
//           <img src="/Petiva-logo.png" alt="Petiva Logo" className="w-14 h-14 object-contain" />
...
//         {/* ✅ Login/Profile */}
//         {!user ? (
//           <NavLink to="/join-us" className="btn btn-outline bg-[#4CA3B8] text-white btn-sm">
//             Join Us
//           </NavLink>
//         ) : (
    ...
    <div className="navbar bg-base-100 shadow-sm px-4 sticky top-0 z-50">
      ...
      <div className="navbar-end flex items-center gap-3 relative">
        ...
        {!user ? (
          ...
          <div className="dropdown dropdown-end">
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
              <div className="w-10 h-10 rounded-full ring ring-[#F4A300] ring-offset-base-100 ring-offset-2 overflow-hidden">
                <img
                  src={user?.photoURL || "/default-avatar.png"}
                  alt="profile"
